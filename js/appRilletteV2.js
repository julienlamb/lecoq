$(document).ready(function () {
	...
	$('#btnCitron').on('click', function (e) {
		$("#titreTaille").html('Rillettes citron & thyn');
		$("#prixRillette").html('3,50€');
		$("#qteRillette").html(' les 90g');
		$("#presentationIngredients").html('<b class="font-weight-bold">Ingrédients :</b> Viande et gras de poulet origine France (99%), sel de Guérande, poivre, citron & thyn.');
